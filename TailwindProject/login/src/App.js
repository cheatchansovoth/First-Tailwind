...
function App() {
  return (
    <div className="min-h-screen flex items-center justify-center min-w-full bg-[#073B39] ">
      <div className='login-form sm:flex sm:flex-row  items-center justify-start rounded-l-2xl w-[70%] sm:bg-[#253631]'>
        <div className='image hidden md:block '>
          <img src='https://burst.shopifycdn.com/photos/elaborate-building-interior-with-light-teal-walls.jpg?width=1200&format=pjpg&exif=1&iptc=1' className='rounded-l-3xl h-[720px]'></img>
        </div>
        <div className='text-login m-auto'>
