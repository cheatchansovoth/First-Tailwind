...
const About=()=>
{
    return (
        ...
        <Sidebar/>
        <div className='flex flex-col-reverse items-center lg:flex-row lg:flex min-h-max lg:items-start justify-center w-full space-x-10 my-auto'>
                <div className='w-[50%] lg:w-[50%] mt-[20%] mb-[10%] lg:m-0'>
                    <p className='text-4xl font-bold font-sans text-center'>Project</p>
                    <div className='grid lg:grid-cols-2 my-[2%] place-items-center'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='mt-2'>
                        ...
                        <p className='text-2xl font-bold mt-2 underline mb-2'>FrontEnd</p>
                        <div className='grid grid-cols-3 '>
                            <div>
                                <p className='text-4xl font-bold underline my-2 text-red-500'><IoLogoHtml5/></p>
                                <div className="radial-progress text-red-500" style={{"--value":70}}>90%</div>
                            </div>
                            <div>
                                <p className='text-4xl font-bold underline my-2 text-blue-500'><IoLogoCss3/></p>
                                <div className="radial-progress text-blue-500" style={{"--value":70}}>80%</div>
                            </div>
                            <div>
                                <p className='text-3xl font-bold underline my-2 text-purple-600'><BsFillBootstrapFill/></p>
                                <div className="radial-progress text-purple-600" style={{"--value":70}}>80%</div>
                            </div>
                            <div>
                                <p className='text-4xl font-bold underline my-2 text-blue-400'><IoLogoReact/></p>
                                <div className="radial-progress text-blue-400" style={{"--value":70}}>60%</div>
                            </div>
                        </div>
                        <p className='text-2xl font-bold mt-5 mb-2 underline'>Backend</p>
                        <div className='grid grid-cols-3 '>
                            <div>
                            ...
                            <div>
                                ...
                                <div className="radial-progress text-green-500" style={{"--value":70}}>50%</div>
                            </div>
                            <div>
                                <p className='text-3xl font-bold underline my-2 text-green-700'><SiNodedotjs/></p>
                                <div className="radial-progress text-green-700" style={{"--value":70}}>60%</div>
                            </div>
                        </div>
                    </div>
